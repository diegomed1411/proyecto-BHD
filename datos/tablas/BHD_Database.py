...
def crearTabla(conexion):
    ...
    conexion.execute(
        'CREATE TABLE RECLAMOS(ID_RECLAMO INTEGER PRIMARY KEY AUTOINCREMENT, DESCRIPCION TEXT NOT NULL, ID_INMUEBLE TEXT NOT NULL, ID_UNIDAD TEXT NOT NULL, ID_USUARIO INTEGER NOT NULL, ID_SERVICIO, FECHA DATETIME, ESTADO TEXT NOT NULL, FOREIGN KEY(ID_INMUEBLE) REFERENCES INMUEBLES(ID_INMUEBLE), FOREIGN KEY(ID_UNIDAD) REFERENCES UNIDADES(ID_UNIDAD), FOREIGN KEY(ID_USUARIO) REFERENCES USUARIOS_RESIDENTES(ID_USUARIO),FOREIGN KEY(ID_SERVICIO) REFERENCES SERVICIOS(ID_SERVICIOS))')
   # conexion.execute(
    ...
    conexion.execute(
        'CREATE TABLE SESIONES(ID INTEGER PRIMARY KEY AUTOINCREMENT, ID_USUARIO INTEGER, FECHA_HORA TEXT, FOREIGN KEY(ID_USUARIO) REFERENCES USUARIOS_RESIDENTES(ID_USUARIO))')
...
def tablaAlt(conexion):
    conexion.execute('CREATE TABLE RECLAMOS(ID_RECLAMO INTEGER PRIMARY KEY AUTOINCREMENT, DESCRIPCION TEXT NOT NULL, ID_INMUEBLE TEXT NOT NULL, ID_UNIDAD TEXT NOT NULL, ID_USUARIO INTEGER NOT NULL, ID_SERVICIO, FECHA DATETIME, ESTADO TEXT NOT NULL, FOREIGN KEY(ID_INMUEBLE) REFERENCES INMUEBLES(ID_INMUEBLE), FOREIGN KEY(ID_UNIDAD) REFERENCES UNIDADES(ID_UNIDAD), FOREIGN KEY(ID_USUARIO) REFERENCES USUARIOS_RESIDENTES(ID_USUARIO),FOREIGN KEY(ID_SERVICIO) REFERENCES SERVICIOS(ID_SERVICIOS))')
